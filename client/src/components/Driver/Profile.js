    ...
    <>
      {userData ? (
        <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', border: '1.5px solid black', borderBottomRightRadius:'8px',borderBottomLeftRadius:'8px',  width:'50%', height: '450px', margin: '0 auto', backgroundColor: 'whitesmoke' }}>
